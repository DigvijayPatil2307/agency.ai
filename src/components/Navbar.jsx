...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    ...
    max-sm:pt-20 max-sm:z-30 max-sm:overflow-hidden
    flex flex-row sm:items-center gap-5 transition-all duration-300
    ${sidebarOpen ? "max-sm:w-60 max-sm:pl-10" : "max-sm:w-0"}`}
        >
          <img
